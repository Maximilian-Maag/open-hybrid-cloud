...
\definecolor{infrashelf-blue}{HTML}{131921}
\definecolor{infrashelf-amber}{HTML}{febd69}
...
\titleformat{\chapter}[display]
  {\normalfont\huge\bfseries\color{infrashelf-blue}}
  {\chaptertitlename\ \thechapter}{12pt}{\Huge}
\titleformat{\section}
  {\normalfont\Large\bfseries\color{infrashelf-blue!80}}
  {\thesection}{1em}{}
\titleformat{\subsection}
  {\normalfont\large\bfseries\color{infrashelf-blue!60}}
  {\thesubsection}{1em}{}
...
\begin{titlepage}
  \begin{tikzpicture}[remember picture, overlay]
    \fill[infrashelf-blue] (current page.north west) rectangle
      ([yshift=-5cm] current page.north east);
    \fill[infrashelf-amber] ([yshift=-5cm] current page.north west) rectangle
...
\begin{tikzpicture}[node distance=1.2cm and 1.6cm,
  box/.style={rectangle, draw=infrashelf-blue!70, fill=infrashelf-blue!10,
...
\begin{lstlisting}[style=bash]
# Backup PostgreSQL
docker exec infrashelf-postgres pg_dump -U postgres infrashelf \
  | gzip > backup-$(date +%Y%m%d).sql.gz

# Restore
zcat backup-20260101.sql.gz \
  | docker exec -i infrashelf-postgres psql -U postgres infrashelf
\end{lstlisting}
...
\begin{tikzpicture}[node distance=1.2cm and 1.8cm,
  ...
  svc/.style={rectangle, rounded corners=4pt, draw=infrashelf-amber!80, fill=infrashelf-amber!20,
...
stringData:
  ...
  API_URL: "http://infrashelf-backend:3001"
\end{lstlisting}
...
\begin{lstlisting}[style=bash]
kubectl exec -n infrashelf deploy/infrashelf-backend -- \
...
# Kubernetes
kubectl exec -n infrashelf deploy/infrashelf-postgres -- \
...
\centering
\begin{tikzpicture}[
  tbl/.style={rectangle, draw=infrashelf-blue!50, fill=infrashelf-blue!6,
  ...
  casc/.style={->, >=Stealth, infrashelf-blue!80, thick, dashed},
...
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}[
  state/.style={rectangle, rounded corners=6pt, draw=infrashelf-blue!60,
                fill=infrashelf-blue!10, minimum width=3.2cm,

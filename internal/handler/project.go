...
func (h *Handler) projectCreate(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.projects.Create(r.Context(), p); err != nil {
		h.redirectWithFlash(w, r, "/projects/new", "error", "Projekt konnte nicht erstellt werden.")
		return
	}
	h.redirectWithFlash(w, r, "/projects", "success", "Projekt erstellt.")
}
...
func (h *Handler) projectUpdate(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.projects.Update(r.Context(), p); err != nil {
		h.redirectWithFlash(w, r, "/projects/"+strconv.FormatInt(id, 10), "error", "Fehler beim Speichern.")
		return
	}
